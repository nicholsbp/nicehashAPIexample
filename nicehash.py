...
class private_api:
    ...
    def get_rig_stat(self, rigId):  # all about one rig
        return self.request('GET', '/main/api/v2/mining/rig2/' + rigId, '', None)

    def get_rig_stat_1(self, rigId):  # rig's algo list
        return self.request('GET', '/main/api/v2/mining/algo/stats/', rigId, None)

    def get_rig_stat_2(self):  # rig list
        return self.request('GET', '/main/api/v2/mining/groups/list/', '', None)

    def get_rig_stat_3(self):  # btc address
        return self.request('GET', '/main/api/v2/mining/info/', '', None)
